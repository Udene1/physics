...
import { getProblemAnswerSpec } from './problem-answer-specs.js';

export interface AnswerEvaluation { correct:boolean; matchedCriteria:string[]; missingCriteria:string[]; }
